...
| Item | Status | Notes |
|---|---|---|
| `CRON_SECRET` env var in Vercel prod | ✅ | Confirmed set in Vercel production (Jun 22, 2026). |
...
**✅ PASS** — `CRON_SECRET` confirmed in Vercel production (Jun 22, 2026). Both cron routes are active and auth-gated.
