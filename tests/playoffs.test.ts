...
describe("Standings (W-L-T)", () => {
  it("computes standings from matchup results", () => {
    const teams = [
      { id: "team1", name: "Team 1", leagueId: "league1", ownerId: "user1", draftOrder: 1, isBot: false, accentColor: null, createdAt: new Date(), updatedAt: new Date() },
      { id: "team2", name: "Team 2", leagueId: "league1", ownerId: "user2", draftOrder: 2, isBot: false, accentColor: null, createdAt: new Date(), updatedAt: new Date() },
      { id: "team3", name: "Team 3", leagueId: "league1", ownerId: "user3", draftOrder: 3, isBot: false, accentColor: null, createdAt: new Date(), updatedAt: new Date() },
    ];
